package com.automationteststore.testCases.Demos.DemoPractice.Generic_Methods;
...
public class Generic_WaitMethods {
    WebDriver driver;

    public Generic_WaitMethods(WebDriver driver) {
        this.driver = driver;
    }
