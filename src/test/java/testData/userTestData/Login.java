...
public class Login {
    ...
    // Change Job Reference Decision page testData.data
    ...
    // Covid Related job page testData.data
    ...
    // Where will you advertise Job BasePage Data
    ...
    // List the main responsibilities of the job to create your job description BasePage
    // testData.data
    ...
    // Define the criteria for the job to create your person specification BasePage testData.data
    ...
    // Enter Name of Qualification BasePage testData.data
    public static String NAME_OF_QUALIFICATION = "Doctor";
    // Enter Name of Registration BasePage testData.data
    ...
    // Safeguard Questions BasePage testData.data
    ...
    // Job Seeker Method of Apply BasePage testData.data
    public static String METHOD_OF_APPLY = "online";
    public static String METHOD_OF_APPLY_CV = "cv";
    // Fitness To Practise Question BasePage testData.data
    ...
    // Closing date page testData.data
    ...
    public static String APPLICATIONS_DOWNLOAD_FILEPATH =
            System.getProperty("user.dir") + "/File_downloads";
    public static String REPORTING_DOWNLOAD_FILEPATH =
            System.getProperty("user.dir") + "/File_downloads/";
    ...
    // Candidate Details for PDF testData.data
    ...
    // actual testData.data needs to updated in the storydatafile.jsaon this test testData.data is
    // only for validation
